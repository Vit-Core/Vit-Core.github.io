# 3.2NetCore之HelloWorld
>2020-01-27 18:17

------------

Serslot是Sers微服务协议在c#上的实现，Sers提供了3种c#接入的方式，Serslot是对net core2.1 web api的原生支持。无需修改原有web api项目逻辑，修改3处代码即可无缝接入。
[下载源码](https://sersms.github.io/file/demo/SersServiceStationDemo2.1.1.250.zip)
